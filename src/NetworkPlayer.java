...
public class NetworkPlayer extends Player
{
    ...
    public NetworkPlayer( World world, Player p1 )
    {
        super(world);
        refPlayer = p1;
    }
    ...
    public void getState( GameContainer gc, StateBasedGame sbg, int delta )
    {
        ...
        if (gc.getInput().isKeyDown(Input.KEY_RSHIFT)) {
            ...
            if (playerPlatformed) {
                playerVelocity = new Vector(0, -Player.PLAYER_VELOCITY_Y);
    ...
    public void moveStop( ) {
        ...
        this.setPosition( this.getPosition().getX() + this.refPlayer.getPlayerVelocity().getX(), this.getPosition().getY() + this.getPlayerVelocity().getY() );
    }
    ...
    public void moveLeft( int delta ) {
        ...
        this.setPosition( this.getPosition().getX() + this.playerVelocity.getX() +  this.refPlayer.getPlayerVelocity().getX(), this.getPosition().getY() + this.getPlayerVelocity().getY() );
    }
...
//            if (playerPlatformed) {
//                playerVelocity = new Vector(playerVelocity.getX(), -0.4f);
//                playerPlatformed = false;
//            }
//        }
//        else if( !playerPlatformed )
...
//    {
//        Vector v = new Vector( playerVelocity.getX() + playerLocal.getPlayerVelocity().getX(),
