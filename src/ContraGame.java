...
public class ContraGame extends StateBasedGame {
	...
	public static Image getBlockTexture(String key) {
		return blockTextureHashMap.get(key);
	}

	public static SpriteSheet getBlockSpriteSheet(String key) {
		return blockSpriteSheetHashMap.get(key);
	}
