...
public class EnemyRunner extends Player implements Serializable {
    ...
    public EnemyRunner(World world , Player p1, float worldPosX, float worldPosY){
        ...
        playerDesc = new PlayerDescriptor(PlayerDescriptor.State.RUNNING, PlayerDescriptor.Movement.LEFT, PlayerDescriptor.HorizontalFacingDirection.LEFT, PlayerDescriptor.VerticalFacingDirection.NONE);
