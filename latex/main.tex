...
\titleline{Enemies List}
Some of the common enemies present in the game.

\begin{itemize}
	\item Charges at the player, suicide style 
	\begin{center}
		\includegraphics[scale=1]{images/runner.png} 
	\end{center}
	
	\item Stationary enemy, shoots at the player 
	\begin{center}
		\includegraphics[scale=1]{images/shooter.png} 
	\end{center}

	\item Hides in the water and shoots explosives
	\begin{center}
		\includegraphics[scale=1]{images/waterEnemy.png} 
	\end{center}

	\item Sniper: slow shot frequency but high accuracy. 
	\begin{center}
		\includegraphics[scale=1]{images/sniper.png} 
	\end{center}

	\item Alien bug: charges at the player with high velocity and agility.
	\begin{center}
		\includegraphics[scale=.7]{images/alien.png} 
	\end{center}
